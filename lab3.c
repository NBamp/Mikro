...
int main(){
	...
	struct Element ELementsTable[] = {E1,E2,E3};
	struct Signal SignalsTable[] = {s1,s2,s3,s4,s5,s6}; /*stands for a,b,c,d,e,f,*/
	float* TopInputs[] = {&(SignalsTable[0].value),&(SignalsTable[1].value),&(SignalsTable[2].value)};
